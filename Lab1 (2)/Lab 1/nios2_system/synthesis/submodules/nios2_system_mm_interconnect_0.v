...
module nios2_system_mm_interconnect_0 (
	...
	wire          cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> leds_green_s1_agent:cp_valid
	wire  [102:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> leds_green_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // leds_green_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [11:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> leds_green_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> leds_green_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> leds_green_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> leds_red_s1_agent:cp_valid
	wire  [102:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> leds_red_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                     // leds_red_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [11:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> leds_red_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> leds_red_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> leds_red_s1_agent:cp_endofpacket
	...
	wire  [102:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> keys_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                     // keys_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [11:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> keys_s1_agent:cp_channel
	...
	wire          leds_green_s1_agent_rp_valid;                                              // leds_green_s1_agent:rp_valid -> router_005:sink_valid
	wire  [102:0] leds_green_s1_agent_rp_data;                                               // leds_green_s1_agent:rp_data -> router_005:sink_data
	wire          leds_green_s1_agent_rp_ready;                                              // router_005:sink_ready -> leds_green_s1_agent:rp_ready
	wire          leds_green_s1_agent_rp_startofpacket;                                      // leds_green_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          leds_green_s1_agent_rp_endofpacket;                                        // leds_green_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [102:0] leds_red_s1_agent_rp_data;                                                 // leds_red_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [102:0] keys_s1_agent_rp_data;                                                     // keys_s1_agent:rp_data -> router_008:sink_data
	...
	wire   [84:0] sdram_s1_agent_rp_data;                                                    // sdram_s1_agent:rp_data -> router_012:sink_data
	...
	wire          onchip_mem_s1_agent_rp_valid;                                              // onchip_mem_s1_agent:rp_valid -> router_013:sink_valid
	wire   [84:0] onchip_mem_s1_agent_rp_data;                                               // onchip_mem_s1_agent:rp_data -> router_013:sink_data
	wire          onchip_mem_s1_agent_rp_ready;                                              // router_013:sink_ready -> onchip_mem_s1_agent:rp_ready
	wire          onchip_mem_s1_agent_rp_startofpacket;                                      // onchip_mem_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          onchip_mem_s1_agent_rp_endofpacket;                                        // onchip_mem_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire   [84:0] router_012_src_data;                                                       // router_012:src_data -> sdram_s1_rsp_width_adapter:in_data
	wire          router_012_src_ready;                                                      // sdram_s1_rsp_width_adapter:in_ready -> router_012:src_ready
	wire   [11:0] router_012_src_channel;                                                    // router_012:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire  [102:0] sdram_s1_rsp_width_adapter_src_data;                                       // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_010:sink_data
	...
	wire          router_013_src_valid;                                                      // router_013:src_valid -> onchip_mem_s1_rsp_width_adapter:in_valid
	wire   [84:0] router_013_src_data;                                                       // router_013:src_data -> onchip_mem_s1_rsp_width_adapter:in_data
	wire          router_013_src_ready;                                                      // onchip_mem_s1_rsp_width_adapter:in_ready -> router_013:src_ready
	wire   [11:0] router_013_src_channel;                                                    // router_013:src_channel -> onchip_mem_s1_rsp_width_adapter:in_channel
	wire          router_013_src_startofpacket;                                              // router_013:src_startofpacket -> onchip_mem_s1_rsp_width_adapter:in_startofpacket
	wire          router_013_src_endofpacket;                                                // router_013:src_endofpacket -> onchip_mem_s1_rsp_width_adapter:in_endofpacket
	wire          onchip_mem_s1_rsp_width_adapter_src_valid;                                 // onchip_mem_s1_rsp_width_adapter:out_valid -> rsp_demux_011:sink_valid
	wire  [102:0] onchip_mem_s1_rsp_width_adapter_src_data;                                  // onchip_mem_s1_rsp_width_adapter:out_data -> rsp_demux_011:sink_data
	wire          onchip_mem_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_011:sink_ready -> onchip_mem_s1_rsp_width_adapter:out_ready
	wire   [11:0] onchip_mem_s1_rsp_width_adapter_src_channel;                               // onchip_mem_s1_rsp_width_adapter:out_channel -> rsp_demux_011:sink_channel
	wire          onchip_mem_s1_rsp_width_adapter_src_startofpacket;                         // onchip_mem_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_011:sink_startofpacket
	wire          onchip_mem_s1_rsp_width_adapter_src_endofpacket;                           // onchip_mem_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_011:sink_endofpacket
	wire          cmd_mux_010_src_valid;                                                     // cmd_mux_010:src_valid -> sdram_s1_cmd_width_adapter:in_valid
	wire  [102:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> sdram_s1_cmd_width_adapter:in_data
	...
	wire          cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> onchip_mem_s1_cmd_width_adapter:in_valid
	wire  [102:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> onchip_mem_s1_cmd_width_adapter:in_data
	wire          cmd_mux_011_src_ready;                                                     // onchip_mem_s1_cmd_width_adapter:in_ready -> cmd_mux_011:src_ready
	wire   [11:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> onchip_mem_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> onchip_mem_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> onchip_mem_s1_cmd_width_adapter:in_endofpacket
	...
	wire          leds_green_s1_agent_rdata_fifo_src_valid;                                  // leds_green_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] leds_green_s1_agent_rdata_fifo_src_data;                                   // leds_green_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          leds_green_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_003:in_0_ready -> leds_green_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                         // avalon_st_adapter_003:out_0_valid -> leds_green_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> leds_green_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                         // leds_green_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                         // avalon_st_adapter_003:out_0_error -> leds_green_s1_agent:rdata_fifo_sink_error
	...
	wire          onchip_mem_s1_agent_rdata_fifo_src_valid;                                  // onchip_mem_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [17:0] onchip_mem_s1_agent_rdata_fifo_src_data;                                   // onchip_mem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          onchip_mem_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_011:in_0_ready -> onchip_mem_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> onchip_mem_s1_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> onchip_mem_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                         // onchip_mem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> onchip_mem_s1_agent:rdata_fifo_sink_error
	...
	nios2_system_mm_interconnect_0_router_012 router_012 (
	...
	nios2_system_mm_interconnect_0_router_012 router_013 (
	...
	nios2_system_mm_interconnect_0_cmd_mux_002 cmd_mux_010 (
		.clk                 (sdram_pll_sys_clk_clk),                 //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_system_mm_interconnect_0_rsp_demux_002 rsp_demux_010 (
		.clk                (sdram_pll_sys_clk_clk),                        //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	nios2_system_mm_interconnect_0_avalon_st_adapter_010 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
